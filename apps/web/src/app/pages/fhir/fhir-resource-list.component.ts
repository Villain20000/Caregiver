          ...
          @for (resource of resources(); track resource.id) {
            <div class="resource-card" [class.expanded]="expandedId() === resource.id">
              <button
                ...
                [attr.aria-controls]="
                  expandedId() === resource.id ? 'resource-detail-' + resource.id : null
                "
                (click)="onToggle(resource.id)"
              >
                <span class="resource-meta">
                  <span class="resource-type">{{ resource.resourceType }}</span>
                  <span class="resource-status" [class]="resource.validationStatus">{{
              ...
              @if (expandedId() === resource.id) {
                <div [id]="'resource-detail-' + resource.id">
...
export class FhirResourceListComponent {
  ...
  /** Toggle the detail panel for the given resource. */
  onToggle(id: string): void {
    this.toggleResource.emit(id);
  }
}
