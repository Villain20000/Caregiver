/**
 * apps/web/src/app/pages/orders/order-lab-form.component.ts
 *
 * Presentational form for creating a lab order.
 */
import { Component, effect, inject, input, output } from '@angular/core';
import { CommonModule } from '@angular/common';
import { ReactiveFormsModule, FormBuilder, Validators } from '@angular/forms';
import type { CreateLabOrderRequest } from '@caregiver/contracts';
...
export class OrderLabFormComponent {
  ...
  /** Emits a lab order creation payload. */
  readonly submitOrder = output<CreateLabOrderRequest>();
