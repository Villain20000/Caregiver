...
@Component({
        ...
        <form [formGroup]="filterForm" (ngSubmit)="onSearch()">
          <div class="form-row">
            ...
            <div class="form-field">
              ...
              <input id="resourceType" type="text" formControlName="resourceType" placeholder="e.g. Patient" />
            </div>
            <div class="form-field">
              ...
              <tbody>
                @for (log of logs(); track log.id) {
                  <tr [class.failure]="log.result === 'failure'">
                    ...
                    <td><span class="result" [class]="log.result">{{ log.result }}</span></td>
  ...
  styles: [`
    ...
    .create-btn, .reset-btn {
      ...
      border: none; border-radius: 4px; cursor: pointer; margin-right: 0.5rem;
    }
    ...
    .audit-table th, .audit-table td {
      padding: 0.6rem; text-align: left; border-bottom: 1px solid #e0e0e0;
    }
    .audit-table th { background: #f5f5f5; color: #333; font-weight: 600; }
    .audit-table tr:hover { background: #fafafa; }
    .audit-table tr.failure { background: #ffebee; }
    .result {
